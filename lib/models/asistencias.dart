...
List<Asistencias> asistenciasFromMap(String str) => List<Asistencias>.from(json.decode(str).map((x) => Asistencias.fromMap(x)));

String asistenciasToMap(List<Asistencias> data) => json.encode(List<dynamic>.from(data.map((x) => x.toMap())));

class Asistencias {
    int id;
    DocenteMaterias docenteMaterias;
    String estado;
    String horaMarcada;
    String fecha;
    ...
    factory Asistencias.fromMap(Map<String, dynamic> json) => Asistencias(
        id: json["id"],
        docenteMaterias: DocenteMaterias.fromMap(json["docenteMaterias"]),
        estado: json["estado"],
    ...
    Map<String, dynamic> toMap() => {
        "id": id,
        "docenteMaterias": docenteMaterias.toMap(),
        "estado": estado,
...
class DocenteMaterias {
    ...
    factory DocenteMaterias.fromMap(Map<String, dynamic> json) => DocenteMaterias(
        id: json["id"],
